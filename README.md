...
## Objective
To understand what the Master Boot Record (MBR) is and to read and analyze the first 512 bytes of a USB drive using Linux.
...
Folders
Operating systems
➡️ A disk stores only binary data (0 and 1).
...
➡️ The first sector read by BIOS is the MBR.
Functions of MBR
...
➡️ MBR exists before all higher-level disk structures.
MBR Location
